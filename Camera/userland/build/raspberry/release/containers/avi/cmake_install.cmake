# Install script for directory: /home/pi/git_server/Camera/userland/containers/avi
...
FILE(INSTALL DESTINATION "/opt/vc/lib/plugins" TYPE SHARED_LIBRARY FILES "/home/pi/git_server/Camera/userland/build/lib/reader_avi.so")
  IF(EXISTS "$ENV{DESTDIR}/opt/vc/lib/plugins/reader_avi.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/opt/vc/lib/plugins/reader_avi.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/opt/vc/lib/plugins/reader_avi.so")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/opt/vc/lib/plugins" TYPE SHARED_LIBRARY FILES "/home/pi/git_server/Camera/userland/build/lib/writer_avi.so")
  IF(EXISTS "$ENV{DESTDIR}/opt/vc/lib/plugins/writer_avi.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/opt/vc/lib/plugins/writer_avi.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/opt/vc/lib/plugins/writer_avi.so")
