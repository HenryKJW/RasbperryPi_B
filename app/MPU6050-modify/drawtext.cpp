...
bool DrawText::on_draw(const Cairo::RefPtr<Cairo::Context>& cr)
{
...
void DrawText::draw_rectangle(const Cairo::RefPtr<Cairo::Context>& cr,
...
void DrawText::draw_text(const Cairo::RefPtr<Cairo::Context>& cr,
