...
/// Base of the DMA registers.
/// Available after bcm2835_init has been called
extern volatile uint32_t *bcm2835_dma;
...
//Memory Access
#define SETBIT(base, bit) (*((volatile uint32_t *) base)) |= 1<<bit
#define CLRBIT(base, bit) (*((volatile uint32_t *) base)) &= ~(1<<bit)
...
#define BCM2835_PWM_DMA_ENABLE		0x80000000	///< DMA Enable
#define BCM2835_PWM_DMA_PANIC_DREQ	0x0707		///< Defualt, don`t change
...
typedef enum{
   BCM2835_PWM_OUTPUTMODE_PWM,
   BCM2835_PWM_OUTPUTMODE_SERIALISER,
} bcm2835PWMOutputMode;

typedef enum
{
   BCM2835_PWM_ALGORITHM,
   BCM2835_MS_ALGORITHM,
} BCM2835_PWM_Mode_Algorithm;

typedef enum
{
   BCM2835_DATA_REGEISTER,
   BCM2835_FIFO,
} BCM2835_PWM_DATA_FROM;

//Defines for DMA --------------------------------------------------------------------------
#define PAGE_SIZE (4096)

#define BCM2835_DMA0				0x0000 /// DMA0
#define BCM2835_DMA1				0x0100 /// DMA1
#define BCM2835_DMA2				0x0200 /// DMA2
#define BCM2835_DMA3				0x0300 /// DMA3
#define BCM2835_DMA4				0x0400 /// DMA4
#define BCM2835_DMA5				0x0500 /// DMA5
#define BCM2835_DMA6				0x0600 /// DMA6
#define BCM2835_DMA7				0x0700 /// DMA7
#define BCM2835_DMA8				0x0800 /// DMA8
#define BCM2835_DMA9				0x0900 /// DMA9
#define BCM2835_DMA10				0x0A00 /// DMA10
#define BCM2835_DMA11				0x0B00 /// DMA11
#define BCM2835_DMA12				0x0C00 /// DMA12
#define BCM2835_DMA13				0x0D00 /// DMA13
#define BCM2835_DMA14				0x0E00 /// DMA14

//word offsets (ie 4 byte multiples)
#define BCM2835_DMA_CS				0 
#define BCM2835_DMA_CONBLK_AD	1
#define BCM2835_DMA_TI				2
#define BCM2835_DMA_SOURCE_AD	3
#define BCM2835_DMA_DEST_AD		4
#define BCM2835_DMA_TXFR_LEN		5
#define BCM2835_DMA_STRIDE		6
#define BCM2835_DMA_NEXTCONBK	7
#define BCM2835_DMA_DEBUG			8

#define BCM2835_DMA_CS_Reset		0x80000000 /// Reset and will self clear
#define BCM2835_DMA_CS_Stops		0x00000020 /// 1-DMA paused, 0-DMA run (RO)
#define BCM2835_DMA_CS_Enable		0x00000001 /// 1-Enable

#define BCM2835_DMA_TI_NO_WIDE_BURSTS	0x04000000 /// 1-not use bursts, 0-use bursts
#define BCM2835_DMA_TI_SRC_READ_DREQ	0x00000400 /// 1-Source DREQ selected by PERMAP and 0-DREQ has no effect
#define BCM2835_DMA_TI_SRC_WIDTH			0x00000200 /// 1-Source Address Increment(128bit or 32bit) and 0-not change
#define BCM2835_DMA_TI_SRC_INC			0x00000100 /// 1-128bit source and 0-32bit source
#define BCM2835_DMA_TI_DEST_WRITE_DREQ	0x00000040 /// 1-Dest DREQ selected by PERMAP and 0-DREQ has no effect
#define BCM2835_DMA_TI_DEST_WIDTH		0x00000020 /// 1-128bit destination and 0-32bit destination
#define BCM2835_DMA_TI_DEST_INC			0x00000010 /// 1-Dest Address Increment(128bit or 32bit) and 0-not change
#define BCM2835_DMA_WAIT_RESP			0x00000008 /// 1-Wait for the write response to be received defore proceeding and 0-don`t wait

/// \brief bcm2835 DMA Register Channel 0~14 Control Block Data Structure
///
/// DMA Register Channel 15 address 0x7EE05000
typedef struct {
...
/// \brief bcm2835 DMA Control Block Data Structure
typedef struct {
    volatile unsigned int TI;
    volatile unsigned int SOURCE_AD;
    volatile unsigned int DEST_AD;
...
//DAM get phycial address
typedef struct {
    void* p;  // physical address
    void* v;   // virtual address
}PageInfo ;

/// \brief bcm2835 DMA PreMAP - TI: 20~16 bit
typedef enum {
	BCM2835_DMA_DREQ_NONO,
	BCM2835_DMA_DREQ_DSI_1,
	BCM2835_DMA_DREQ_PCM_TX,
	BCM2835_DMA_DREQ_PCM_RX,
	BCM2835_DMA_DREQ_SMI,
	BCM2835_DMA_DREQ_PWM,				//5
	BCM2835_DMA_DREQ_SPI_TX,
	BCM2835_DMA_DREQ_SPI_RX,
	BCM2835_DMA_DREQ_BSC_SPI_SLAVE_TX,
	BCM2835_DMA_DREQ_BSC_SPI_SLAVE_RX,
	BCM2835_DMA_DREQ_unused,				//10
	BCM2835_DMA_DREQ_MMC,
	BCM2835_DMA_DREQ_UART_TX,
	BCM2835_DMA_DREQ_SD_HOST,
	BCM2835_DMA_DREQ_UART_RX,
	BCM2835_DMA_DREQ_DSI_2,				//15
	BCM2835_DMA_DREQ_SLIMBUS_MCTX,
	BCM2835_DMA_DREQ_HDMI,
	BCM2835_DMA_DREQ_SLIMBUS_MCRX,
	BCM2835_DMA_DREQ_SLIMBUS_DC0,
	BCM2835_DMA_DREQ_SLIMBUS_DC1,		//20
	BCM2835_DMA_DREQ_SLIMBUS_DC2,
	BCM2835_DMA_DREQ_SLIMBUS_DC3,
	BCM2835_DMA_DREQ_SLIMBUS_DC4,
	BCM2835_DMA_DREQ_SCALER_FIFO_0_And_SMI,
	BCM2835_DMA_DREQ_SCALER_FIFO_1_And_SMI,	//25
	BCM2835_DMA_DREQ_SCALER_FIFO_2_And_SMI,
	BCM2835_DMA_DREQ_SLIMBUS_DC5,
	BCM2835_DMA_DREQ_SLIMBUS_DC6,
	BCM2835_DMA_DREQ_SLIMBUS_DC7,
	BCM2835_DMA_DREQ_SLIMBUS_DC8,				//30
	BCM2835_DMA_DREQ_SLIMBUS_DC9,
	BCM2835_DMA_PreMAP_END,
} bcm2835DmaDREQPreMAP;

//Defines for CM ------------------------------------------------------------------
//General Purpose Clocks Control
#define BCM2835_CM_GP0CTL			0x0070
#define BCM2835_CM_GP1CTL			0x0078
#define BCM2835_CM_GP2CTL			0x0080

//General Purpose Clocks Divisors
#define BCM2835_CM_GP0DIV			0x0074
#define BCM2835_CM_GP1DIV			0x007c
#define BCM2835_CM_GP2DIV			0x0084

#define BCM2835_CM_GPxCTL_ENAB	0x0010
#define BCM2835_CM_GPxCTL_KILL	0x0020
#define BCM2835_CM_GPxCTL_BUSY	0x0080
#define BCM2835_CM_GPxCTL_FLIP	0x0100

/// \brief bcm2835 GPxCTL Clock Source
typedef enum {
	BCM2835_CM_ClockSource_GND,
	BCM2835_CM_ClockSource_Oscillator,			/// 19.2MHz
	BCM2835_CM_ClockSource_Testdebug0,
	BCM2835_CM_ClockSource_Testdebug1,
	BCM2835_CM_ClockSource_PLLA_per,
	BCM2835_CM_ClockSource_PLLC_per,
	BCM2835_CM_ClockSource_PLLD_per,			/// 500MHz
	BCM2835_CM_ClockSource_HDMI_Auxiliary,
	BCM2835_CM_ClockSource_END,
} bcm2835CMClockSource;

/// \brief bcm2835 GPxCTL Mash Control
typedef enum {
	BCM2835_CM_MashControl_Integer_Division,
	BCM2835_CM_MashControl_1_Stage_Mash,
	BCM2835_CM_MashControl_2_Stage_Mash,
	BCM2835_CM_MashControl_3_Stage_Mash,
	BCM2835_CM_MashControl_END,	
} bcm2835CMMashControl;

/// \brief bcm2835 CM Clock Tyep
typedef enum {
	BCM2835_CM_PWMCLK,			///0x7E101040
	BCM2835_CM_GP0CLK,			///0x7E101070
	BCM2835_CM_GP1CLK,			///0x7E101078
	BCM2835_CM_GP2CLK,			///0x7E101080
	BCM2835_CM_ClockType_END,
} bcm2835CMClockType; //PCM_CLK-0x7E101098�BPWM_CLK=0x7E1010A0

/// \brief bcm2835 GPxCTL Register
struct BCM2835_GPCTL {
    char SRC		: 4;		///bcm2835CMClockType
    char ENAB		: 1;
    char KILL		: 1;
    char			: 1;
    char BUSY		: 1;
    char FLIP		: 1;
    char MASH		: 2;		///bcm2835CMMashControl
    unsigned int	: 13;
    char PASSWD	: 8;		///5A
};
...
extern "C" {
  ...
  /// Sets the outmode of the given PWM channel,
  /// allowing you to control the PWM output mode and enable/disable that channel
  /// \param[in] channel The PWM channel. 0 or 1.
  /// \param[in] outmode. PWM outputmode or Serialiser outputmode
  /// \param[in] datafrom. Data_Register or FIFO (size:32bit x16)
  extern void bcm2835_pwm_set_channel_out(uint8_t channel, uint8_t outmode, uint8_t datafrom);

 /// Reset PWM channel mode, then enable PWM.
  /// \param[in] channel The PWM channel. 0 or 1.
  extern void bcm2835_pwm_reset_pwm_enable(uint8_t channel);

  /// Sets the FIFO of the given PWM channel
  /// \param[in] channel The PWM channel. 0 or 1.
  /// \param[in] repeatlastdata. transmission interrupts FIFO is empty or Last data in FIFO is transmitted repetedly until FIFO is not empty
  extern void bcm2835_pwm_set_fifo_ctl(uint8_t channel, uint8_t repeatlastdata);

  /// Clean PWM FIFO Data
  /// \param[in] cleanfifo. Clean FIFO Data. TURE is clean (auto clean to 0), FALSE is none.
  extern void bcm2835_pwm_reset_fifo(uint8_t cleanfifo);

  /// Sets the PWM filo data,
  /// \param[in] FIFO Data 32bit (buffer:32bit x16)
  extern void bcm2835_pwm_set_fifo_data(uint32_t fifodata);
  	
  /// \defgroup Clock Management access
  /// @{ 
  /// Sets the GPxCLK pulse ratio
  /// \param[in] mash control in bcm2835CMMashControl.
  /// \param[in] clock source in bcm2835CMClockSource.
  /// \param[in] divisor integer. (DIVI size: 12bit)
  /// \param[in] divisor farctional. (DIVF size: 12bit)
  extern void bcm2835_cm_set_clock(uint8_t mashcontrol, uint8_t clocksource, uint32_t divisor_integer, uint32_t divisor_farctional);

  /// Sets the All clock pulse ratio
  /// \param[in] clock type in bcm2835CMClockType.
  /// \param[in] mash control in bcm2835CMMashControl.
  /// \param[in] clock source in bcm2835CMClockSource.
  /// \param[in] divisor integer. (DIVI size: 12bit)
  /// \param[in] divisor farctional. (DIVF size: 12bit)
  extern void bcm2835_all_set_clock(uint8_t clocktype, uint8_t mashcontrol, uint8_t clocksource, uint32_t divisor_integer, uint32_t divisor_farctional);

  /// Sets the PWM DAM
  /// \param[in] enabled Set true to enable PWM DMA function.
  extern void bcm2835_pwm_set_DMA(uint8_t enable);
  /// @} 

  /// \defgroup DMA access
  /// @{ 
  /// allocate memorys, provide visual address and phyical address
  /// \param[in] point type of visual memory address.
  /// \param[in] point type of phyical memory address.
  extern void getRealMemPage(void** vAddr, void** pAddr) ;

  /// Release memory
  /// \param[in] point type of visual memory address.
  extern void freeRealMemPage(void* vAddr);

  /// Setup DMAs and Enable DMA
  /// \param[in] DMAPage:Phyical address
  extern void bcm2835_DMA_SetupDMA(void** DMAPage);

  /// Reset DMA
  extern void bcm2835_DMA_unSetupDMA(void);
    /// @} 
