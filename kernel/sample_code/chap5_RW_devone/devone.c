...
static int devone_open(struct inode *inode, struct file *file)
{
	...
	file->private_data = p;
//add Henry by switch differen minor
	switch(iminor(inode))
	{
		case 0:
			devone_0_open(inode,file);
			break;
		case 1:
			devone_1_open(inode,file);
			break;
		default:
			printk(" minor is not define open function \n");
			break;
	}
//End
	return 0;
